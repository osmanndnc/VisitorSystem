    ...
    <div class="py-6 max-w-7xl mx-auto">
        <div class="user-form-card">
            <div class="form-header">
                ...
                <div class="form-title">Yeni Kişi Ekle</div>
            </div>
            <div class="form-body">
                <form id="person-form" method="POST" action="{{ route('admin.persons.store') }}" class="space-y-4">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="phone_number" value="{{ old('phone_number') }}" class="w-full">
                    ...
                    <div class="flex justify-end form-footer">
                         <button type="submit" form="person-form" class="submit-animated" id="submit-button">
                            <span>Kişi Ekle</span>
