<x-app-layout>
    <style>
        ...
        .passive-row{ opacity:.55; background:#f9fafb !important; transition: opacity .3s; }
        .toggle-switch {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (submitBtn) {
                ...
                submitBtn.addEventListener('click', function (e) {
                    // Formdaki tüm required alanlar doluysa submit et
                    if (form.checkValidity()) {
                        ...
                        // Eğer form geçerli değilse, tarayıcının varsayılan
                        // validasyon uyarılarını gösteririz.
                        form.reportValidity();
                    }
                });
            }
    ...
    <div class="py-6 max-w-7xl mx-auto" 
         x-data="{ 
             ...
             formData: {
                ...
                password: '', role: 'security'
             },
             isEditing: false,
             openCreateForm() {
                 this.formAction = '{{ route('security.users.store') }}';
        ...
        <div class="text-center mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Güvenlik Listesi</h2>
        </div>
                                ...
                                <td class="actions-column">
                                    @if(auth()->user()->hasAnyRole(['admin', 'super_admin']))
                                        <button @click="openEditForm({
                                                    ...
                                                    email: @js($user->email),
                                                    role: @js($user->role),
                                                    updateUrl: @js(route('security.users.update', $user->id))
